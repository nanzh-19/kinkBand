...
for i=1:count
    ...
    e12_unrotated(i)=(e2(i)-e1(i))*sin(pi-2*jiaodu_)/2;
...
for i=1:count
   Stress=zeros(2,2);
   Stress(1,1)=c(1,1)*0.5*(defgra11_nonzero(i)^2+defgra12_nonzero(i)^2-1)+c(1,2)*0.5*(defgra12_nonzero(i)^2+defgra22_nonzero(i)^2-1)+c(1,3)*defgra11_nonzero(i)*defgra12_nonzero(i);
   Stress(2,2)=c(1,2)*0.5*(defgra11_nonzero(i)^2+defgra12_nonzero(i)^2-1)+c(2,2)*0.5*(defgra12_nonzero(i)^2+defgra22_nonzero(i)^2-1)+c(2,3)*defgra11_nonzero(i)*defgra12_nonzero(i);
   Stress(1,2)=c(1,3)*0.5*(defgra11_nonzero(i)^2+defgra12_nonzero(i)^2-1)+c(2,3)*0.5*(defgra12_nonzero(i)^2+defgra22_nonzero(i)^2-1)+c(3,3)*defgra11_nonzero(i)*defgra12_nonzero(i);
